...
# description
'description':
"""As you awake, the light you just turned on shines in your face. You can now see the room around you and you get up. You try to open the door but, the knob won't budge.""",
# goal
'goal':
"""You should figure out why you are locked in a room. Are you crazy? Were you kidnapped? What the heck is going on?""",
# choices
'choices':
...
# description
'description':
"The light you just ran into, crashes into the ground and brakes into pieces, you will need to find another light source.",
# goal
'goal':
...
# description
'description' :
"You awake inside of a dark room. You cannot see much, like not a lot stuff. Yep.",
# goal
'goal':
"You should turn on the light before you go any further. That's probably a good idea.",
# choices
'choices' :
